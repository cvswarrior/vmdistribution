...
Metamodellnek nevezzünk azt, amiben egy adott dolgot tudunk modellezni, vagyis leegyszerűsítve ábrázolni. Például egy labor metamodellje alatt egy olyan nyelvet kell elképzelni, amiben leírható tetszőleges oktatási labor. \Aref{fig:emfobj}-es ábra egy ilyen metamodell egyik osztályát ábrázolja.
...
Metamodell osztályok között lehetnek kapcsolatok is, amelyek közül a két legfontosabb a tartalmazás(kompozíció) és a referencia. \Aref{fig:emfcomp}-es ábrán egy kompozícióra, \ref{fig:emfref}-ösön egy referenciára láthatunk példát.
