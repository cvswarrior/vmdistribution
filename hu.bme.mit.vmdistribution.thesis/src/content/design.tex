...
\begin{itemize}
  ...
  \item \code{\large \textbf{UPLOAD}(\textit{vm}: VirtualMachine, \textit{pc}: Computer)}: Feltölti a VM-et a Computer-re, vagyis hozzáadja annak a \code{virtualmachines} listájához.
\end{itemize}
