...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>vmdistribution</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class VmdistributionExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(VmdistributionPackage.eNS_URI, 
			 VmdistributionPackage.eINSTANCE);
